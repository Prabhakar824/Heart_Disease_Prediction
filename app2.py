...
def personal_details():
    if request.method == 'POST':
        ...
        return redirect(url_for('heart_disease_form', Name=request.args.get('Name')))
    
    # Render page3.html with Name and age passed from page2.html
...
def heart_disease_form():
    if request.method == 'POST':
        try:
            ...
            # Handle gender radio button input
            ...
            result = "Make your heart healthy" if model_prediction[0] == 1 else "You Have a Healthy Heart"
